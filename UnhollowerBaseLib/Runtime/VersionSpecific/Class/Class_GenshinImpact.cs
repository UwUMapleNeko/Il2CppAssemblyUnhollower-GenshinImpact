...
namespace UnhollowerBaseLib.Runtime.VersionSpecific.Class {
    ...
    public class NativeClassStructHandler_GenshinImpact : INativeClassStructHandler {
        public unsafe INativeClassStruct CreateNewClassStruct(int vTableSlots) {
            var pointer = Marshal.AllocHGlobal(Marshal.SizeOf<Il2CppClass_GenshinImpact>() +
                                               Marshal.SizeOf<VirtualInvokeData>() * vTableSlots);

            var il2CppClass = (Il2CppClass_GenshinImpact*)pointer;
            *il2CppClass = default;

            il2CppClass->byval_arg = il2CppClass->this_arg =
                (NativeTypeStructHandler_GenshinImpact.Il2CppType_GenshinImpact*)Marshal.AllocHGlobal(Marshal.SizeOf<NativeTypeStructHandler_GenshinImpact.Il2CppType_GenshinImpact>());
...
#if DEBUG
        public string GetName() => "NativeClassStructHandler_GenshinImpact";
#endif

        [StructLayout(LayoutKind.Sequential)]
        internal unsafe struct Il2CppClass_GenshinImpact {
            // The following fields are always valid for a Il2CppClass structure
            public Il2CppImage* image; // const
            public IntPtr gc_desc;
            public IntPtr name; // const char*
            public IntPtr namespaze; // const char*
            public NativeTypeStructHandler_GenshinImpact.Il2CppType_GenshinImpact* byval_arg; // not const, no ptr
            public NativeTypeStructHandler_GenshinImpact.Il2CppType_GenshinImpact* this_arg; // not const, no ptr
        ...
        internal unsafe class NativeClassStructWrapper : INativeClassStruct {
            ...
            public IntPtr VTable => IntPtr.Add(Pointer, Marshal.SizeOf<Il2CppClass_GenshinImpact>());

            private Il2CppClass_GenshinImpact* NativeClass => (Il2CppClass_GenshinImpact*)Pointer;
            ...
            private static int bitfield1offset =
                Marshal.OffsetOf<Il2CppClass_GenshinImpact>(nameof(Il2CppClass_GenshinImpact.bitfield_1)).ToInt32();

            private static int bitfield2offset =
                Marshal.OffsetOf<Il2CppClass_GenshinImpact>(nameof(Il2CppClass_GenshinImpact.bitfield_2)).ToInt32();
            ...
            public INativeTypeStruct ThisArg => UnityVersionHandler.Wrap((Il2CppTypeStruct*)NativeClass->byval_arg);
            ...
            public ref Il2CppClass* Class => ref NativeClass->castClass;
